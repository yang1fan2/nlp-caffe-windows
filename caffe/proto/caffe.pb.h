...
enum LayerParameter_LayerType {
  ...
  LayerParameter_LayerType_TEST_PROTP = 38
};
...
const LayerParameter_LayerType LayerParameter_LayerType_LayerType_MAX = LayerParameter_LayerType_TEST_PROTP;
...
const LayerParameter_DimCheckMode LayerParameter_DimCheckMode_DimCheckMode_MIN = LayerParameter_DimCheckMode_PERMISSIVE;
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  static const LayerType TEST_PROTP = LayerParameter_LayerType_TEST_PROTP;
